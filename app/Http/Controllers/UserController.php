<?php
    ...
    class UserController extends Controller
    {
        ...
        public function store(Request $request)
        {
            ...
            // FIX: form sekarang selalu kirim is_active (lewat hidden input + checkbox),
            // jadi cukup baca apa adanya tanpa default tersembunyi yang menutupi uncheck.
        ...
        public function update(Request $request, User $user)
        {
            ...
            // FIX KRITIS: Sebelumnya pakai $request->boolean('is_active', true) — jika
            // admin uncheck "Akun aktif" lalu submit, browser TIDAK mengirim field ini
            // sama sekali (perilaku standar checkbox HTML), sehingga default `true` selalu
            // dipakai dan akun TIDAK PERNAH bisa dinonaktifkan lewat form Edit.
            // Sekarang form punya hidden input fallback '0' sebelum checkbox, jadi field
            // 'is_active' selalu terkirim (1 jika dicentang, 0 jika tidak).
            $validated['is_active'] = $request->boolean('is_active');
