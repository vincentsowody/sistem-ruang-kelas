        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
            ...
            <div class="bg-gray-50 rounded-xl p-4">
                <p class="text-sm font-medium text-gray-700 mb-3">
                    ...
                    Ubah Password <span class="text-gray-400 font-normal">(kosongkan jika tidak ingin diubah)</span>
                </p>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="relative">
                        <input type="password" name="password" id="password" placeholder="Password baru"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                    ...
                    <div class="relative">
                        <input type="password" name="password_confirmation" id="password2" placeholder="Konfirmasi"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
            ...
            <div>
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    @php $isSelected = old('role', $user->role) == $role['value']; @endphp
                    <label class="flex flex-col items-center gap-2 p-3 border rounded-xl cursor-pointer transition
                                  {{ $isSelected ? 'bg-'.$role['color'].'-50 border-'.$role['color'].'-300' : 'border-gray-200 hover:bg-gray-50' }}">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nip_nim" value="{{ old('nip_nim', $user->nip_nim) }}"
            ...
            <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                ...
                <label for="isActive" class="text-sm text-gray-700 cursor-pointer">
                    Akun aktif
                    @if($user->id === auth()->id())
                    <span class="text-gray-400">(tidak dapat mengubah status akun sendiri)</span>
                    @endif
                </label>
            </div>
        </div>
